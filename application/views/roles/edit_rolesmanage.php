                    ...
                    <div class="card">
                        <div class="card-body">
                            <Form role="form" enctype="multipart/form-data" name="myForm"
                                action="<?php echo base_url('roles/Rolesmanage/update_role/' . $role_data['id']); ?>"
                                method="post">
                                <div class="form-group col-md-12">
                                    <label for="role">Role Type<span class="text-danger">*</span></label>
                                    <input type="text" required class="form-control"
                                        value="<?php echo isset($role_data['role']) ? $role_data['role'] : ''; ?>"
                                        id="role" name="role" placeholder="Enter role name" />
