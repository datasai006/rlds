    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Edit and view Code Value</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section>
            <div class="row p-3">
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('Code_values/update/'.$code_value['id']) ?>" method="post">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required="" class="form-control" id="code_value_cd"
                                        name="code_value_cd" value="<?= $code_value['code_value_cd'] ?>" />
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="code_type_id">Code type<span class="text-danger">*</span></label>
                                    <input type="text" required="" class="form-control" id="code_type_id"
                                        name="code_type_id" value="<?= $code_value['code_type_id'] ?>" />
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="code_value_desc">Code type description<span
                                            class="text-danger">*</span></label>
                                    <input type="text" required="" class="form-control" id="code_value_desc"
                                        name="code_value_desc" value="<?= $code_value['code_value_desc'] ?>" />
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="code_value_desc_val">Code type description<span
                                            class="text-danger">*</span></label>
                                    <input type="text" required="" class="form-control" id="code_value_desc_val"
                                        name="code_value_desc_val" value="<?= $code_value['code_value_desc_val'] ?>" />
                                </div>
                                <!-- <div class="form-group col-md-12">
                                    <label for="parent_code_value_id">Parent code type id<span
                                            class="text-danger">*</span></label>
                                    <input type="text" required="" class="form-control" id="parent_code_value_id"
                                        name="parent_code_value_id"
                                        value="<?= $code_value['parent_code_value_id'] ?>" />
                                </div> -->
                                <div class="form-group text-right m-b-0">
                                    <button class="btn badge-primary" type="submit">
                                        Update
                                    </button>
                                    <a href="<?= base_url('code_values') ?>" class="btn btn-light"
