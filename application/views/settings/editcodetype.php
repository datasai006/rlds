        ...
        <section>
            <div class="row p-3">
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('Code_types/update/'.$code_type['id']) ?>" method="post">
                                <div class="form-group col-md-12">
                                    <label for="code_type_cd">Code type<span class="text-danger">*</span></label>
                                    <input type="text" required="" class="form-control"
                                        value="<?= $code_type['code_type_cd'] ?>" id="code_type_cd" name="code_type_cd"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required="" class="form-control" id="code_type_desc"
                                        value="<?= $code_type['code_type_desc'] ?>" name="code_type_desc"
                                        placeholder="Enter role name" />
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="code_type_desc_val">Code type description<span
                                            class="text-danger">*</span></label>
                                    <input type="text" required="" class="form-control" id="code_type_desc_val"
                                        value="<?= $code_type['code_type_desc_val'] ?>" name="code_type_desc_val"
                                        placeholder="Enter role name" />
                                </div>
                                <!-- <div class="form-group col-md-12">
                                    ...
                                    <input type="text" required="" class="form-control" id="parent_code_type_id"
                                        value="<?= $code_type['parent_code_type_id'] ?>" name="parent_code_type_id"
                                        placeholder="Enter role name" />
                                </div> -->
                                <div class="form-group text-right m-b-0">
                                    ...
                                    <a href="<?= base_url('Code_types') ?>" class="btn btn-light"
