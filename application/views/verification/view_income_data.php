    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>view Income verification</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="<?= base_url('Dashboard') ?>">Home / HRMS / Income verification</a>
                            </li>
        ...
        <section>
            <div class="card">
                <h5 class="p-3">Income verification</h5>
                <hr />
                <div class="d-flex">
            ...
            <div class="p-3">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $income->id  ?></td>
                            <td><?= $income->application_name ?></td>
                            <td><?= $income->branch_name ?></td>
                            <td><?= $income->income_type ?></td>
                            <td><?= $income->yearly_income ?></td>
                            <td><?= $income->assessment_year ?></td>
                            <td style="color: blue">
                                <a href="<?php echo base_url()?>verification/Income/edit_income/<?= $income->id; ?>"><i
                                        class=" bi bi-pencil-square"></i></a> |
                                <a href="<?=base_url();?>verification/Income/delete_income/<?= $income->id;?>">
