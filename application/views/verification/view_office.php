    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>view Office Verification</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="<?= base_url('Dashboard') ?>">Home / HRMS / Office Verification</a>
                            </li>
        ...
        <section>
            <div class="card">
                <h5 class="p-3">Office Verification</h5>
                <hr />
                <div class="d-flex">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row->Mobile_no ?></td>
                                <td style="color: blue">
                                    <a href="<?php echo base_url('verification/office/edit_office/' . $row->id); ?>"><i
                                            class=" bi bi-pencil-square"></i></a> |
                                    <a href="<?php echo base_url('verification/office/delete_office/' . $row->id); ?>">
