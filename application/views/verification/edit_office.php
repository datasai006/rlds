                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="<?= base_url('Dashboard') ?>">Home / Office</a>
                            </li>
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title"> Office Verification</h3>
                    ...
                    <form class="ajax-form" id="final_form2">
                        ...
                        <div class="d-md-none section ">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="signature" id="signature"
                                    style="width: 100% ">
                                <input type="hidden" name="current_signature" value="<?php echo $current_signature; ?>">
                        ...
                        <div class="d-md-none section ">
                            ...
                            <div class="form-group">
                                <label>Stamp</label>
                                <input type="file" class="form-control" name="stamp" id="stamp" style="width: 100% ">
                        ...
                        <div class="d-md-none section ">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="applicant_name"
                                    placeholder="AIDNI ENGINEERS" value="<?php echo $office_data->applicant_name; ?>"
                                    style="width: 100% ">
                                </input>
                            </div>
                            <button class="btn btn-primary mt-3 backBtn">Back</button>
                        ...
                        <div class="d-md-none section ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ref_number" placeholder="97/29-09-2023"
                                    value="<?php echo $office_data->ref_number; ?>" style="width: 100% ">
                                </input>
                            </div>
                            <button class="btn btn-primary mt-3 backBtn">Back</button>
                            <button class="btn btn-success mt-3 submitBtni2">submit</button>
                        </div>

                    </form>
                    <!----------------------- small devices code end here ------------------------------------------->
                    <form role="form" enctype="multipart/form-data" id="" name="myForm"
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-md-4 d-md-block d-none">
                                ...
                                <select name="WorkingSince" class="form-control" id="WorkingSince" required>
                                    <option>------select no of years------</option>
                                    <option value="1"
                                        <?php echo ($office_data->WorkingSince == '1') ? 'selected' : ''; ?>>1
                                    </option>
                                    <option value="2"
                                        <?php echo ($office_data->WorkingSince == '2') ? 'selected' : ''; ?>>2
                                    </option>
                                    <option value="3"
                                        <?php echo ($office_data->WorkingSince == '3') ? 'selected' : ''; ?>>3
                                    </option>
                                    <option value="4"
                                        <?php echo ($office_data->WorkingSince == '4') ? 'selected' : ''; ?>>4
                                    </option>
                                    <option value="5"
                                        <?php echo ($office_data->WorkingSince == '5') ? 'selected' : ''; ?>>5
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-4 d-md-block d-none">
                                ...
                                <select name="Indicate" class="form-control" id="Indicate">
                                    <option value="">--select--</option>
                                    <option value="No"
                                        <?php echo ($office_data->Indicate == 'No') ? 'selected' : ''; ?>>NO
                                    </option>
                                    <option value="Yes"
                                        <?php echo ($office_data->Indicate == 'Yes') ? 'selected' : ''; ?>>
                                        YES</option>
                                </select>
                            </div>
