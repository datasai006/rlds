                        ...
                        <form class="ajax-form" id="final-form">
                            <!-- <div class="d-md-none section quickForm" id="section1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="application-name"
                            ...
                            <div class="d-md-none section" id="section6" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="Assessment-Year"
                            ...
                            <div class="d-md-none section" id="section9" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="current-section" name="current-section" value="1">
                                    <select class="form-control select2 w-100" name="proof-submitted"
                                        style="width: 100%">
